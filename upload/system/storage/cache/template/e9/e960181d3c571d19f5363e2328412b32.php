...
class __TwigTemplate_3090c1fdf857b199fd781bcc92b500b6 extends Template
{
    private $source;
    private $macros = [];
...
\thtml += '\t\t<p>";
        ...
        echo "</p>';
\thtml += '\t\t<p><strong>' + \$('#modal-security input[name=\\'path\\']').val() + \$('#modal-security input[name=\\'directory\\']').val() + '/</strong></p>';
\thtml += '\t</li>';
\thtml += '\t<li>';
\thtml += '\t\t<p>";
        // line 128
...
\thtml += '\t\t<p>";
        ...
        echo "</p>';
\thtml += '\t\t<p><strong>define(\\'DIR_STORAGE\\', \\'' + \$('#modal-security input[name=\\'path\\']').val() + \$('#modal-security input[name=\\'directory\\']').val() + '/\\');</strong></p>';
\thtml += '\t</li>';
\thtml += '\t<li>';
\thtml += '\t\t<p>";
        // line 134
...
//--></script>";
    ...
    {
        return array (  254 => 136,  249 => 134,  242 => 130,  237 => 128,  230 => 124,  226 => 123,  222 => 122,  188 => 91,  139 => 45,  132 => 41,  124 => 38,  119 => 36,  115 => 34,  109 => 33,  101 => 31,  93 => 29,  90 => 28,  86 => 27,  81 => 25,  74 => 21,  66 => 16,  62 => 15,  56 => 12,  50 => 9,  44 => 6,  37 => 1,);
    }
